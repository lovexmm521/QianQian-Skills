...
**Don't assume. Don't hide confusion. Surface tradeoffs. Deeply analyze the root cause of problems (First Principles).**
...
**Minimum code that solves the problem. Nothing speculative. Maintain simplicity and maintainability (KISS Principle).**

- Code should only satisfy current requirements; over-engineering is strictly forbidden.
- Leverage existing tools and libraries; do not reinvent the wheel.
